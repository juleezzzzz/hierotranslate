...
function createStackedHieroglyphs(hieroglyphString) {
    ...
    if (hieroglyphString.includes('|')) {
        ...
        const stackedSigns = signs.map((sign, index) => {
            // Le premier signe n'a pas de marge, les suivants sont plus rapprochés
    ...
    if (hieroglyphString.includes('⌂')) {
        ...
        return `<span style="display: inline-flex; flex-direction: column; align-items: center; justify-content: center; vertical-align: middle;">
            ...
            <span style="display: inline-flex; justify-content: center; align-items: flex-start; gap: 0.1em; font-size: 1.1em; line-height: 1; margin-top: -0.15em;">
